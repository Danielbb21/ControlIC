...
public class UsuariosController : Controller 
{
    ...
    //---------------------------------------------------------------------------------------------------//
        ...
        public async Task<IActionResult> CadastroProfessor(InputModelProfessor professor) 
        {
            ...
            if (professor.DataNascimento == null || string.IsNullOrEmpty(professor.DataNascimento.ToString())) ModelState.AddModelError("DataNascimento", "Campo precisa estar preenchido");
            if (professor.DataNascimento >= DateTime.Now || professor.DataNascimento.Year < 1900) ModelState.AddModelError("DataNascimento", "Data inválida.");
            else if (professor.Titulacao.DataTitulacao >= DateTime.Now || professor.Titulacao.DataTitulacao <= professor.DataNascimento) ModelState.AddModelError("Titulacao.DataTitulacao", "Data inválida.");
    ...
    //---------------------------------------------------------------------------------------------------//
        ...
        public IActionResult CadastroEstudante(InputModelEstudante estudante) 
        {
            ...
            if (estudante.DataNascimento == null || string.IsNullOrEmpty(estudante.DataNascimento.ToString())) ModelState.AddModelError("DataNascimento", "Campo precisa estar preenchido");
            if (estudante.DataNascimento >= DateTime.Now || estudante.DataNascimento.Year < 1900) ModelState.AddModelError("DataNascimento", "Data inválida.");
            else if (estudante.DataIngresso >= DateTime.Now.Year || estudante.DataIngresso <= estudante.DataNascimento.Year) ModelState.AddModelError("DataIngresso", "Ano de ingresso inválido.");  
    ...
    //---------------------------------------------------------------------------------------------------//
        ...
        public IActionResult Cadastro(Usuario usuario)
        {
            try
            {
                ...
                if (usuarioCadastrado != null) ModelState.AddModelError("Email", "E-mail já utilizado.");
    ...
    //---------------------------------------------------------------------------------------------------//
        ...
        public IActionResult Profile(String id)
        {
            ...
            if (TempData["token"] != null && id == TempData["token"].ToString())
            {
                return View();
            }
